# Generated by Powerlevel10k configuration wizard on 2019-08-07 at 22:07 EDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 31460.
# Wizard options: nerdfont-complete + powerline, large icons, classic, dark,
# angled separators, blurred heads, blurred tails, 2 lines, dotted, left frame, sparse,
# few icons, concise.
